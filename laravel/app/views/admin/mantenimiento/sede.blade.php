...
@section('includes')
    ...
    @include( 'admin.mantenimiento.js.sede_ajax' )
    @include( 'admin.mantenimiento.js.sede' )
@stop
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Mantenimiento de Sedes</li>
            </ol>
        </section>
...
@section('formulario')
     @include( 'admin.mantenimiento.form.sede' )
@stop
